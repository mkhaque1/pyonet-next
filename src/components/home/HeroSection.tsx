        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Innovative <span className="gradient-text">Tech Solutions</span>{' '}
              for Tomorrow&apos;s Challenges
            </h1>
            <p className="text-lg md:text-xl text-dark-300 mb-8 max-w-2xl mx-auto lg:mx-0">
              Pyonet delivers cutting-edge technology services to transform your
            ...
            <div className="mt-12 flex items-center justify-center lg:justify-start gap-8">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-dark-800 overflow-hidden"
                  >
                    <img
              ...
              <div>
                <p className="text-dark-300 text-sm">
                  Trusted by{' '}
                  <span className="text-primary-400 font-medium">500+</span>{' '}
                  clients
                </p>
              </div>
            </div>
          ...
          >
            <div className="relative">
              ...
              <div
                className="absolute -bottom-6 -left-6 glassmorphism p-4 rounded-xl animate-float shadow-lg"
